...
>>>>>>> a404d17ddc80bfde0c9dee1079cb084ab78817bf
class TLDetector(object):
    ...
    def waypoints_cb(self, waypoints):
        ...
        self.stop_posts, self.stop_index = self.all_stop_wp(self.config["stop_line_positions"]) # from find_stop_pos
    ...
    def get_closest_stop_wp(self, current_pose, stopping_indices, limit_distance):
        ...
        for indx in stopping_indices:
            ...
            if dist < limit_distance and self.is_waypoint_behind_ego_car(current_pose.pose, self.waypoints[indx]):
                stop_wp = indx
